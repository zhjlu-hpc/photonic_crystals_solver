...
function [elem, ind_n, ind_l, ind_f] = ...
    Generate_new_element_per(Mesh,cube,N,ind_n,ind_l,ind_f)
...
if cube(1) == N
    ...
    cube_n = cube;
    cube_n(1) = 1;
    iNO = cube_number(cube_n,N);
    
    elem.index_face(2) = Mesh(iNO).index_face(1);
    ...
    elem.index_node(2) = Mesh(iNO).index_node(1);
    elem.index_node(3) = Mesh(iNO).index_node(4);
    elem.index_node(7) = Mesh(iNO).index_node(8);
    elem.index_node(6) = Mesh(iNO).index_node(5);
    ...
    elem.index_line(2) = Mesh(iNO).index_line(4);
    elem.index_line(7) = Mesh(iNO).index_line(8);
    elem.index_line(10) = Mesh(iNO).index_line(12);
    elem.index_line(6) = Mesh(iNO).index_line(5);
...
if cube(2) == N
 ...
 %   elem.index_face(3) = Mesh(iNO).index_face(4);
    elem.index_face(4) = Mesh(iNO).index_face(3);
    ...
    elem.index_node(4) = Mesh(iNO).index_node(1);
    elem.index_node(8) = Mesh(iNO).index_node(5);
    elem.index_node(7) = Mesh(iNO).index_node(6);
    elem.index_node(3) = Mesh(iNO).index_node(2);
    ...
    elem.index_line(8) = Mesh(iNO).index_line(5);
    elem.index_line(11) = Mesh(iNO).index_line(9);
    elem.index_line(7) = Mesh(iNO).index_line(6);
    elem.index_line(3) = Mesh(iNO).index_line(1);
...
if cube(3) == N
 ...
 %   elem.index_face(5) = Mesh(iNO).index_face(6);    
    elem.index_face(6) = Mesh(iNO).index_face(5);
    ...
    elem.index_node(5) = Mesh(iNO).index_node(1);
    elem.index_node(6) = Mesh(iNO).index_node(2);
    elem.index_node(7) = Mesh(iNO).index_node(3);
    elem.index_node(8) = Mesh(iNO).index_node(4);
    ...
    elem.index_line(9) = Mesh(iNO).index_line(1);
    elem.index_line(10) = Mesh(iNO).index_line(2);
    elem.index_line(11) = Mesh(iNO).index_line(3);
    elem.index_line(12) = Mesh(iNO).index_line(4);
...
% max_n = max(elem.index_node);
% max_l = max(elem.index_lnes);
% max_f = max(elem.index_face);
